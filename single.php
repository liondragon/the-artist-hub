...
get_header('blog'); ?>
<section id="page_content" class="page_content <?php if (is_active_sidebar('blog-widget-area')) {
	echo 'sidebar_active';
} ?>">
	<div class="inner">
						...
						<div class="authorinfo">
							...
							<div class="profile-info">
								<?php if (get_the_author_meta('user_url')): ?>
									<a href="<?php the_author_meta('user_url'); ?>"><?php the_author_meta('first_name'); ?>'s
										website</a> |
								<?php endif; ?>
								<?php if (get_the_author_meta('twitter')): ?>
									Follow <?php the_author_meta('first_name'); ?> on <a
										href="http://www.twitter.com/<?php the_author_meta('twitter'); ?>">Twitter</a> |
								<?php endif; ?>
