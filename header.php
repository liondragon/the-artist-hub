...
<head>
	...
	<link rel="preload"
		href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/fonts/open-sans/open-sans-v17-latin-regular.woff2"
		as="font" type="font/woff2" crossorigin>
	<link rel="preload"
		href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/fonts/museo-sans/museo-sans-300.woff2"
		as="font" type="font/woff2" crossorigin>
	<?php wp_head(); ?>
</head>
				...
				<div class="logo_img">
					<svg id="tfa_logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 134.71 32.82">
						...
						<g id="Text">
							...
							<path class="logo-text" d="m46.6,15.52h1.2v9.27h-1.2v-9.27Z" />
							<path class="logo-text"
							...
							<path class="logo-accent" d="m37.3,7.8h-1.8v-.65h4.35v.65h-1.8v4.6h-.74v-4.6Z" />
							<path class="logo-accent"
						...
						<circle id="BG" class="logo-main" cx="16.41" cy="16.41" r="16.41" />
						<g id="Logo">
