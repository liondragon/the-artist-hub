...
function better_comments( $comment, $args, $depth ) {
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<div class="pingback-entry"><span class="pingback-heading"><?php esc_html_e( 'Pingback:', 'the-artist' ); ?></span> <?php comment_author_link(); ?></div>
	<?php
		break;
		default :
		...
		<article id="comment-<?php comment_ID(); ?>" class="comment-body">
			...
			<div class="comment-details clr">
				<?php if ( '0' == $comment->comment_approved ) : ?>
					<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'the-artist' ); ?></p>
				<?php endif; ?>
