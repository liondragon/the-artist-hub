				...
				?>
					<a class="project_post col" href="<?php the_permalink(); ?>" title="">
						...
						<div class="project_description">	
							...
							<span>Brand: <?php echo strip_tags( get_the_term_list( $post->ID, 'eq_brand' ) )?></span><br>
							<span>Purchase Date: <?php echo get_post_meta($post->ID, 'equipment_purchase_date', true)?></span><br>
						</div>
					</a>
				<?php endwhile; ?>
			</div><!-- .post_container -->
