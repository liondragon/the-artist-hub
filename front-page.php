	...
	<div class="inner container">
		<section id="latest_projects" class="page_section">
					...
					while ($projects_query->have_posts()) {
						...
						<div>
							<p class="project-date">
								<?php echo esc_html(get_post_meta($post->ID, 'project_start_date', true)); ?>
							</p>
							<a class="project-item section-tab flexbox flex-even clickable" href="<?php the_permalink(); ?>">
								<div class=""><?php echo esc_html(get_post_meta($post->ID, 'project_customer_name', true)); ?>
								</div>
								<div class="currency">
									<?php echo esc_html(get_post_meta($post->ID, 'project_total_amount', true)); ?>
								</div>
							</a>
						</div>
						<?php
			...
			<div class="section-footer">
				<div><a href="<?php echo get_post_type_archive_link('projects') ?>" class="button">View All Projects</a>
				</div>
				<div>
		...
		<section id="summary" class="page_section">
			...
			<div class="section-tab">
				...
				<div class="sub-tab flexbox flex-start stack">
					<div class="inline">Active: <span class="blue">Yes</span></div>
					<div class="inline">Expires: <span class="blue">02/02/2024</span></div>
					<div class="inline"><a target="_blank" rel="noopener noreferrer"
							href="https://coloradosos.gov/biz/FileDocSearchCriteria.do?quitButtonDestination=BusinessFunctions"
							class="button empty">File Periodic Report</a></div>
		...
		<section id="handbook" class="page_section">
			...
			<div class="blocks section-tab">
				<div class="blocks-item"><a href="https://hub.flooringartists.com/project-management/"
						class="button empty">
				...
				<div class="blocks-item"><a href="https://hub.flooringartists.com/floor-installation/"
						class="button empty">
				...
				<div class="blocks-item"><a href="https://hub.flooringartists.com/equipment-organization/"
						class="button empty">
				...
				<div class="blocks-item"><a href="https://hub.flooringartists.com/sales/" class="button empty">
			...
			<div id="marketing_tab" class="section-tab">
				<h3>Marketing</h3>
				<div class="sub-tab flexbox flex-start stack">
				</div>
			</div>
